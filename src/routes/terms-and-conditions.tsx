            ...
            <div className="mt-12 space-y-12">
              ...
              <Section title="2. About Wildmaze Safaris">
                <p>
                  ...
                  <strong className="text-foreground">Registered business name:</strong> WILDMAZE SAFARIS<br />
                  <strong className="text-foreground">Address:</strong> 19258 Westlands Nairobi<br />
                  <strong className="text-foreground">Email:</strong>{" "}
                  <a href="mailto:Wildmazesafaris@gmail.com" className="line-link">Wildmazesafaris@gmail.com</a>
                  {" / "}
                  <a href="mailto:info@wildmazesafaris.com" className="line-link">info@wildmazesafaris.com</a><br />
                  <strong className="text-foreground">Telephone:</strong> +254719222750
                </p>
                <p>
                  Wildmaze Safaris arranges and provides bespoke safari and travel experiences in
                  Kenya and, where agreed, other destinations.
                </p>
              </Section>
              ...
              <Section title="3. Enquiries and Quotations">
                <p>
                  ...
                  availability; prices may change before confirmation because of supplier
                  availability, exchange rates, park fees, taxes, fuel costs or supplier price
                  changes. A quotation is not a confirmed booking until we provide written
                  confirmation and receive any required deposit. An itinerary may change if a
                  requested lodge, camp, vehicle, guide, flight or activity becomes unavailable.
                </p>
              </Section>

              <Section title="4. Booking Confirmation">
                <p>
                  The Lead Booking Name on paying the deposit acknowledges that they accept these
                  terms and conditions on behalf of themselves and each travelling companion and
                  warrants to the Company that they have the authority to do so.
                </p>
              </Section>
              ...
              <Section title="5. Payment and Confirmation">
                <p>
                  ...
                  deposit. The final 60% payment plus any additional sums due to external transport
                  or transfer operators is due no later than 42 days prior to the proposed date of
                  arrival. If the Client makes a reservation less than 42 days prior to arrival,
                  bookings will only be confirmed upon receipt of a 100% pre-payment, plus any
                  additional sums due to external transport or transfer operators.
                </p>
              </Section>
              ...
              <Section title="6. What Is Included">
                <p>
                  ...
                  accommodation; meals specified; private or shared vehicle and driver-guide
                  services; airport transfers; park, conservancy or activity fees specifically
                  listed; domestic flights or transfers specifically listed; and selected activities
                  specifically listed.
                </p>
              </Section>
              ...
              <Section title="7. What Is Not Included">
                <p>
                  ...
                  passports or travel documents; travel and medical insurance; vaccinations or
                  medical expenses; personal items, drinks, laundry and telephone costs; tips and
                  gratuities; optional activities; excess baggage charges; additional accommodation
                  or transport caused by delays; costs from missed flights or personal itinerary
                  changes; or costs resulting from force majeure.
                </p>
              </Section>
              ...
              <Section title="8. Cancellation by the Client">
                <p>
                  ...
                  <a href="mailto:info@wildmazesafaris.com" className="line-link">info@wildmazesafaris.com</a>.
                ...
                <ul className="list-disc space-y-1 pl-5">
                  <li>30% non-refundable deposit required; remaining 70% due 60 days prior to arrival.</li>
              ...
              <Section title="11. Force Majeure">
                <p>
                  ...
                  control, including natural disasters, epidemic, war, civil unrest, government
                  action, industrial dispute, fire, flood or failure of utilities or transport.
                </p>
              </Section>

              <Section title="12. Travel Documents and Health">
                <p>
                  You are responsible for valid passports, visas, vaccinations and health
                  requirements. Please advise us of any medical, mobility or accessibility needs.
                  Some safari environments have inherent access limitations.
                </p>
              </Section>
              ...
              <Section title="13. Safari and Wildlife Risks">
                <p>
                  ...
                  environmental hazards, limited medical access, and weather or altitude conditions.
                  You must follow guide and supplier instructions and must not approach, feed or
                  interfere with wildlife. You participate at your own risk, subject to rights that
              ...
              <Section title="14. Travel Insurance">
                <p>
                  Travel insurance is strongly recommended and may be required. Your policy should
                  cover medical treatment, emergency evacuation, cancellation, interruption, baggage,
                  delays, personal liability, and safari activities. Wildmaze Safaris is not an
                  insurer and does not provide insurance coverage.
                </p>
              </Section>

              <Section title="15. Accommodation and Service Providers">
                <p>
                  Accommodation, transport, flights and activities may be supplied by independent
                  third parties. Their own terms may apply. We select suppliers with reasonable care
                  but are not responsible for acts or omissions of independent suppliers except where
                  liability cannot lawfully be excluded. Descriptions and photographs are a guide;
                  standards and facilities may vary.
                </p>
              </Section>
              ...
              <Section title="16. Wildlife Sightings and Itinerary Experiences">
                <p>
                  ...
                  particular animal, weather, specific rooms or experiences. Outcomes depend on
                  natural and operational conditions.
                </p>
              </Section>
              ...
              <Section title="18. Complaints">
                <p>
                  ...
                  possible. After travel, contact us in writing with full details. We will
              ...
              <Section title="19. Liability">
                <p>
                  ...
                  to that, Wildmaze Safaris is not liable for loss arising from your failure to follow
              ...
              <Section title="20. Website Content">
                <p>
                  We aim to keep the website accurate but do not guarantee that all content is
                  complete or error-free. You may view and print content for personal non-commercial
                  use. You may not copy or commercially exploit our content without written permission.
                </p>
              </Section>
              ...
              <Section title="22. Website Use">
                <p>
                  You must not use the website unlawfully; attempt unauthorised access; upload
                  malicious code; interfere with security; scrape or harvest information without
              ...
              <Section title="23. Privacy and Cookies">
                <p>
                  ...
                  <Link to="/privacy-policy" className="line-link">Privacy Policy</Link>.
                </p>
              </Section>
