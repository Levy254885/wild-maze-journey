          ...
          <div className="mt-12 space-y-12">
            ...
            <Section title="2. Who We Are">
              <p>
                ...
                SAFARIS LTD
                <br />
                <strong className="text-foreground">Business address:</strong> 19258, Westlands,
                Nairobi
                <br />
                <strong className="text-foreground">Country:</strong> Kenya
                <br />
              ...
              <p>
                ...
                data-protection rights, contact us using the details above.
              </p>
            </Section>
            ...
            <Section title="3. Personal Information We Collect">
              ...
              <p>
                ...
                numbers; postal or billing address; travel dates and preferred destinations; number
                of travellers; accommodation, transport and activity preferences; dietary
                requirements; mobility or accessibility needs; passport or identification where
                required; emergency contacts; payment and transaction information; and information in
                enquiries, reviews or correspondence.
              </p>
              <p>
                Please do not provide sensitive medical information unless it is necessary for your
                travel arrangements or personal safety.
              </p>
              <p className="font-medium text-foreground">Information collected automatically</p>
              <p>
                IP address; browser and device information; operating system; general location; pages
                visited and links clicked; date, time and duration of visits; referral source; cookie
                and similar tracking information; website performance and security information.
              </p>
              <p className="font-medium text-foreground">Information from other sources</p>
              <p>
                We may receive information from your travel agent or employer; airlines, accommodation
                and activity suppliers; payment-service providers; advertising or analytics platforms;
                and individuals travelling with you where they provide information on your behalf.
              </p>
            </Section>

            <Section title="4. How We Use Your Information">
              <p>
                We use personal information to respond to enquiries and provide quotations; design and
                manage safari itineraries; make travel arrangements; process payments; communicate
                about your booking; meet legal and regulatory obligations; prevent fraud; improve our
                website and services; send service messages; send marketing where permitted or with
                consent; request feedback; manage complaints; protect guests, staff and the business;
            ...
            <Section title="5. Legal Basis for Processing">
              <p>
                ...
                vital interests in an emergency. Where we rely on consent, you may withdraw it at any
                time.
              </p>
            </Section>
            ...
            <Section title="6. Travel and Special Requirements">
              <p>
                ...
                requirements, and emergency contacts. We process this only as needed to arrange your
                travel safely. Share only what is necessary.
              </p>
            </Section>

            <Section title="7. Sharing Your Information">
              <p>
                We may share information with accommodation, transport and activity suppliers; payment
                processors; professional advisers; authorities where required by law; and service
                providers who host our systems, under confidentiality arrangements. We do not sell
            ...
            <Section title="9. Marketing">
              <p>
                ...
                safaris and offers. You can unsubscribe at any time using the link in a message or by
                contacting us.
              </p>
            </Section>
            ...
            <Section title="11. Your Data-Protection Rights">
              <p>
                ...
                information; object to or restrict certain processing; withdraw consent; and lodge a
                complaint with the Office of the Data Protection Commissioner. Contact{" "}
                <a href="mailto:Wildmazesafaris@gmail.com" className="line-link text-foreground">
                  Wildmazesafaris@gmail.com
                </a>{" "}
            ...
            <Section title="13. Children's Information">
              <p>
                ...
                participate in a safari, the booking adult must provide the necessary information and
                confirm they are authorised to do so.
              </p>
            </Section>
            ...
            <Section title="16. Contact and Complaints">
              <p>
                ...
                <br />
                Telephone: +254724433483
                <br />
                Address: 19258 Nairobi
              </p>
              <p>You may also contact the Office of the Data Protection Commissioner of Kenya.</p>
              <p className="pt-4">
                <Link to="/terms-and-conditions" className="line-link text-foreground">
